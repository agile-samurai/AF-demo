...
* `tools/training/data-importer-batch` - Our utility for creating new training sets that will generate a new set of training data. This process is time consuming as it will query the following data sources:
  * Movietweetings - A list of the films that represented ground truth, as well as a record of microblogging messages from Twitter users who rated films released after 2009
  * IMDB - 10 years of data on on the film details, actors, and characters identified in movies between June 2009 and June 2019 obtained from a public data dump by the site
  * OMDB - Supplemental data describing the plots and keywords used by our model training 
