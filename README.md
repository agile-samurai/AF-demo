...
```
docker run ugroup/data-science-notebook
```
...
Concourse was used to build our end to end, fully automated pipeline and can be accessed (including build history) at http://XXXXXXXXXXXXXX.
